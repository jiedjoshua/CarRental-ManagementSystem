 ...
 * @author HP
 */
public class rentedCarsTable extends javax.swing.JFrame {

    /**
     * Creates new form rentedCarsTable
     */
    public rentedCarsTable() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rentedCarsTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rentedCarsTable().setVisible(true);
            }
        });
    }
