 ...
 * @author HP
 */
public class rentedCarsUsers extends javax.swing.JFrame {

    /**
     * Creates new form rentedCarsUsers
     */
    public rentedCarsUsers() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Brand", "Model", "Transmission", "Month", "Day", "Year"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rentedCarsUsers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rentedCarsUsers().setVisible(true);
            }
        });
    }
