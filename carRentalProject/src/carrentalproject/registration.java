...
public class registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mNumber.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void createAccActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccActionPerformed
        user = new newUser(fName.getText(),lName.getText(),mNumber.getText(),newUname.getText(),newPwd.getText());
        
        if (user.isStringInt(mNumber.getText()) && user.numCounter(mNumber.getText()))
