...
public class suv extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton3.setBackground(new java.awt.Color(51, 102, 0));
        jToggleButton3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jToggleButton3.setForeground(new java.awt.Color(255, 255, 255));
        jToggleButton3.setText("Filter Date");
   ...
   if ("Default".equals(selectedBrand)) {
        selectedBrand = null;
    }
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        Date selectedDate = jDateChooser1.getDate();
        tablesuv t = new tablesuv(this);
        // Call the sortDate method with the selected date
        t.sortDate(selectedDate);
